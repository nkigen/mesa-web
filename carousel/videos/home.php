                    ...
                    <div class="col-md-12">
                        <div class="row">
							...
							<div class="col-md-3 py-2">
								<div class="card bg-dark" style="width:300px; height:340px;">
								  ...
								  <a class="card-img-top d-flex justify-content-center bg-dark border-dark img-thumbnail w-100 p-0 vid-item" href="index.php?page=watch&code=<?php echo $row['code'] ?>">
									<video style="width:180px; height:220px;" id="<?php echo $row['code'] ?>" class="img-fluid" <?php echo !empty($row['thumbnail_path']) ? "poster='assets/uploads/thumbnail/".$row['thumbnail_path']."'" : '' ?> muted>
