            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-header">
                     <h2 class="card-title mb-2">Welcome <?php echo htmlentities($_SESSION['login']); ?></h2>
                     <span class="d-block mb-4 text-nowrap">Xxxage Technologies Incorporated CEO</span>
                  </div>
                  <br><br>
                  ...
                  <div class="card-body">
                     <div class="row ">
                        <div class="col-md-6">
                           <h1 class="display-6 text-primary mb-2 pt-4 pb-1">Momma I'm gonna make you proud</h1>
                           < <small class="d-block mb-3">@ <br>Lichuma Inc/</small> 
                           <br>
                           <br>
                           <a href="#" target="a_blank" class="btn btn-sm btn-primary">Visit my Website</a>
                        </div>
                        <div class="col-md-6">
