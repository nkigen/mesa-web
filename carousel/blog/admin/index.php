...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../plugins/images/banner.png">
    <title>Mighty Eagles Admin</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.php"><b><img src="../plugins/images/banner.png" style="width: 60px; height: 60px;" alt="home" /></b><span class="hidden-xs"><b>Admin</b></span></a></div>
        ...
        <div id="page-wrapper">
                        ...
                        <div class="white-box">
                            <div class="row row-in">
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">Mighty Eagles Blog Posts</h5> </div>
                                ...
                                <div class="col-lg-3 col-sm-6  b-0">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe016;"></i>
                                            <h5 class="text-muted vb">Mighty Eagles Subscribers</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2023 &copy; Mighty Eagles Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
