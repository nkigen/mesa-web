		...
		<div class="container">
			<div class="w3_agile_banner_top">
				<div class="agile_phone_mail">
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i>+(254) 113 830 797</li>
						<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:ramsleylichuma@gmail.com">ramsleylichuma@gmail.com</a></li>
					</ul>
				</div>
			</div>
